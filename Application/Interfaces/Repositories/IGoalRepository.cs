...
public interface IGoalRepository
{
    ...
    Task<GoalDbResult?>      GetByIdAsync(long goalId, long userId, CancellationToken ct = default);
    ...
    Task<int>                SetStatusAsync(long goalId, long userId, byte statusId, CancellationToken ct = default);
    ...
    Task<IReadOnlyList<MonthlyStatsDbResult>> GetMonthlyStatsAsync(long goalId, long userId, int monthsBack = 3, CancellationToken ct = default);

    // Milestones
    Task<IReadOnlyList<MilestoneDbResult>> GetMilestonesAsync(long goalId, long userId, CancellationToken ct = default);
    ...
    Task<int>                                        DeleteRecurringLinkAsync(long goalId, long userId, long recurringDefinitionId, CancellationToken ct = default);
    Task<IReadOnlyList<GoalRecurringLinkDbResult>>   GetRecurringLinksAsync(long goalId, long userId, CancellationToken ct = default);

    // Dashboard
    Task<GoalDashboardDbResult> GetDashboardAsync(long userId, CancellationToken ct = default);
