...
public interface IRecurringTransactionRepository
{
    ...
    Task<RecurringTransactionDbResult?> GetByIdAsync(long id, CancellationToken ct = default);
    ...
    Task<bool> PauseAsync(long id, long userId, CancellationToken ct = default);
    Task<bool> ResumeAsync(long id, long userId, CancellationToken ct = default);
    ...
    // Dashboard
    Task<RecurringTransactionDashboardDbResult> GetDashboardSummaryAsync(long userId, CancellationToken ct = default);
